...
\section{Methodology}
Our methodology relies on creating controlled experimental environments. We implement standalone solvers for each milestone to ensure that the benchmarking results are not influenced by external library overhead. All experiments were conducted using double-precision floating-point arithmetic.
...
\subsection{Milestone 5: Meta-Analysis}
...
SVM (Constrained) & SV Count / Ratio & 462 / 92.4\% & - \\ \bottomrule
\end{tabular}
\end{table}
